import {
 ...
 var ColorCorrectionDShader = {
	...
	uniforms: {
		...
		'cameraFar': { value: 120 },
		'bColor':  { value: new Vector3( ) },
		'fColor':  { value: new Vector3( ) },
	},
	...
	fragmentShader: [
		...
		'   vec3 effectFG = mix( back.rgb, fColor, fIntensity);',
		'   vec3 effectBG = mix( back.rgb, bColor, bIntensity);',
