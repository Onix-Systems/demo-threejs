...
import { SepiaDShader } from '../shaders/SepiaDShader.js';

var SepiaDPass = function (tex) {
	Pass.call( this );
	if ( SepiaDShader === undefined )
		console.error( 'SepiaDPass relies on SepiaDShader' );
	var shader = SepiaDShader;
...
SepiaDPass.prototype = Object.assign( Object.create( Pass.prototype ), {
	constructor: SepiaDPass,
