...
import { SaturateDShader } from '../shaders/SaturateDShader.js';

var SaturateDPass = function (tex) {
	Pass.call( this );
	if ( SaturateDShader === undefined )
		console.error( 'SaturateDPass relies on SaturateDShader' );
	var shader = SaturateDShader;
...
SaturateDPass.prototype = Object.assign( Object.create( Pass.prototype ), {
	constructor: SaturateDPass,
