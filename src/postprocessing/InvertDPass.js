...
import { InvertDShader } from '../shaders/InvertDShader.js';

var InvertDPass = function (tex) {
	Pass.call( this );
	if ( InvertDShader === undefined )
		console.error( 'InvertDPass relies on InvertDShader' );
	var shader = InvertDShader;
...
InvertDPass.prototype = Object.assign( Object.create( Pass.prototype ), {
	constructor: InvertDPass,
